...
class Packet:
    ...
    def __init__(self, srcAddr, dstAddr, srcPort, dstPort, seqNum, ackNum, ackFlag, ecnFlag, broadcast=None):
        ...
        # Broadcast support:
        # - For DATA packets (ackFlag==0): broadcast can carry the destination ToR id (e.g., "t2")
        # - For ACK packets (ackFlag==1): broadcast can carry the receiver host id (e.g., "h9")
        #   so the sender can track per-receiver cumulative ACKs.
        self.broadcast = broadcast  # None means normal unicast

        self.sendTimeslot = 0
        self.hops = 0
        self.priority = 0

        """Simulator fields. DO NOT TOUCH"""
